...
export const uploadFileToBackend = async (file) => {
	try {
		...
		const data = [
			...
			{
				question:
					'Hi, I\'m scheduled for surgery next week, and I have some questions about the preparation.',
			...
			{
				question:
					'Have you been here before, or will this be your first visit to our department?',
			...
			{
				question:
					'Your surgeon might have given specific instructions about your medication. Have they advised you to continue taking it before the surgery?',
			...
			{
				question:
					'It\'s crucial to follow those instructions carefully. Are you experiencing any unusual pain, bleeding, or discomfort?',
